...
namespace ResourceTest.Controllers
{
    ...
    public class JobTemplatesController : ControllerBase
    {
        ...
        private JobTemplate TransportChemicalSupply(JobTemplate jobTemplate, int i)
        {
            ...
            ////Pick 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Pick
            //                                                                        , "CH_DRUM_BUFFER_GET_ACTION_1"
            //                                                                        , createParameta("action", "CH_DRUM_BUFFER_GET_ACTION_1")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, ["Transferring", "VehicleAcquireStarted"])
            //                                                                        , createPostReport(reports, ["CarrierInstalled", "VehicleAcquireCompleted"])));
            //Drop 위치 이동
            jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Move, MissionTemplateSubType.StopoverMove
                                                                                    , "CapSearch"
                                                                                    ,true
                                                                                    , createParameta("target", "68d78254b2c7dd267f0f1cd2")
                                                                                    , createParameta(null, null)
            ...
            jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Move, MissionTemplateSubType.StopoverMove
                                                                                    , "2Drum_4(Dooropen)"
                                                                                    ,false
                                                                                    , createParameta("target", "68d78254b2c7dd267f0f1cc0")
                                                                                    , createParameta(null, null)
                                                                                    , createPreReport(reports, null)
                                                                                    , createPostReport(reports, null)));
            //Drop 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Drop
            //                                                                        , "CH_DRUM_EQUIPMENT_PUT_ACTION_1"
            //                                                                        , createParameta("action", "CH_DRUM_EQUIPMENT_PUT_ACTION_1")
            //                                                                        , createParameta(null, null)
            ...
            //Drop 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Drop
            //                                                                        , "CH_DRUM_EQUIPMENT_PUT_ACTION_2"
            //                                                                        , createParameta("action", "CH_DRUM_EQUIPMENT_PUT_ACTION_2")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, null)
            //                                                                        , createPostReport(reports, null)));
            //Drop 위치 이동
            jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Move, MissionTemplateSubType.StopoverMove
                                                                                    , "2Drum_2(UR)"
                                                                                    ,false
                                                                                    , createParameta("target", "68d78254b2c7dd267f0f1cc8")
                                                                                    , createParameta(null, null)
                                                                                    , createPreReport(reports, null)
                                                                                    , createPostReport(reports, null)));
            //Drop 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Drop
            //                                                                        , "CH_DRUM_EQUIPMENT_PUT_ACTION_3"
            //                                                                        , createParameta("action", "CH_DRUM_EQUIPMENT_PUT_ACTION_3")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, null)
            //                                                                        , createPostReport(reports, null)));
            //Drop 위치 이동
            ...
            //Drop 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Drop
            //                                                                        , "CH_DRUM_EQUIPMENT_PUT_ACTION_4"
            //                                                                        , createParameta("action", "CH_DRUM_EQUIPMENT_PUT_ACTION_4")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, null)
            //                                                                        , createPostReport(reports, null)));
            return jobTemplate;
        ...
        private JobTemplate TransportChemicalRecovery(JobTemplate jobTemplate, int i)
        {
            ...
            jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Move, MissionTemplateSubType.StopoverMove
                                                                                    ...
                                                                                    , createParameta("target", "68d78254b2c7dd267f0f1cc0")
                                                                                    , createParameta(null, null)
                                                                                    , createPreReport(reports, ["VehicleArrived"])
                                                                                    , createPostReport(reports, null)));
            //Pick 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Pick
            //                                                                        , "CH_DRUM_EQUIPMENT_GET_ACTION_1"
            //                                                                        , createParameta("action", "CH_DRUM_EQUIPMENT_GET_ACTION_1")
            //                                                                        , createParameta(null, null)
            ...
            //Pick 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Pick
            //                                                                        , "CH_DRUM_EQUIPMENT_GET_ACTION_2"
            //                                                                        , createParameta("action", "CH_DRUM_EQUIPMENT_GET_ACTION_2")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, null)
            //                                                                        , createPostReport(reports, null)));
            //Pick 위치 이동
            ...
            //Pick 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Pick
            //                                                                        , "CH_DRUM_EQUIPMENT_GET_ACTION_3"
            //                                                                        , createParameta("action", "CH_DRUM_EQUIPMENT_GET_ACTION_3")
            //                                                                        , createParameta(null, null)
            ...
            //Pick 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Pick
            //                                                                        , "CH_DRUM_EQUIPMENT_GET_ACTION_4"
            //                                                                        , createParameta("action", "CH_DRUM_EQUIPMENT_GET_ACTION_4")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, null)
            ...
            //Drop 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Drop
            //                                                                        , "CH_DRUM_BUFFER_PUT_ACTION_1"
            //                                                                        , createParameta("action", "CH_DRUM_BUFFER_PUT_ACTION_1")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, ["VehicleDepositStarted"])
            //                                                                        , createPostReport(reports, ["CarrierRemoved", "VehicleDepositCompleted"])));
            return jobTemplate;
        ...
        private JobTemplate TransportSlurrySupply(JobTemplate jobTemplate, int i)
        {
            ...
            ////Pick 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Pick
            //                                                                        , "SL_DRUM_BUFFER_GET_ACTION_1"
            //                                                                        , createParameta("action", "SL_DRUM_BUFFER_GET_ACTION_1")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, ["Transferring", "VehicleAcquireStarted"])
            //                                                                        , createPostReport(reports, ["CarrierInstalled", "VehicleAcquireCompleted"])));
            ...
            jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Move, MissionTemplateSubType.StopoverMove
                                                                                    , "Slurry_4(Dooropen)"
                                                                                    ,false
                                                                                    , createParameta("target", "68d78254b2c7dd267f0f1cd3")
                                                                                    , createParameta(null, null)
                                                                                    , createPreReport(reports, null)
                                                                                    , createPostReport(reports, null)));

            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Drop
            //                                                                        , "SL_DRUM_EQUIPMENT_PUT_ACTION_1"
            //                                                                        , createParameta("action", "SL_DRUM_EQUIPMENT_PUT_ACTION_1")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, ["VehicleDepositStarted"])
            //                                                                        , createPostReport(reports, null)));
            ...
            //Drop 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Drop
            //                                                                        , "SL_DRUM_EQUIPMENT_PUT_ACTION_2"
            //                                                                        , createParameta("action", "SL_DRUM_EQUIPMENT_PUT_ACTION_2")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, null)
            //                                                                        , createPostReport(reports, null)));
            ...
            jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Move, MissionTemplateSubType.StopoverMove
                                                                                    , "Slurry_2(UR)"
                                                                                    ,false
                                                                                    , createParameta("target", "68d78254b2c7dd267f0f1cbc")
                                                                                    , createParameta(null, null)
                                                                                    , createPreReport(reports, null)
                                                                                    , createPostReport(reports, null)));
            ...
            //Drop 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Drop
            //                                                                        , "SL_DRUM_EQUIPMENT_PUT_ACTION_3"
            //                                                                        , createParameta("action", "SL_DRUM_EQUIPMENT_PUT_ACTION_3")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, null)
            //                                                                        , createPostReport(reports, null)));
            //Drop 위치 이동
            ...
            ////Drop 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Drop
            //                                                                        , "SL_DRUM_EQUIPMENT_PUT_ACTION_4"
            //                                                                        , createParameta("action", "SL_DRUM_EQUIPMENT_PUT_ACTION_4")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, null)
            //                                                                        , createPostReport(reports, null)));
            return jobTemplate;
        ...
        private JobTemplate TransportSlurryRecovery(JobTemplate jobTemplate, int i)
        {
            ...
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Pick
            //                                                                        , "SL_DRUM_EQUIPMENT_GET_ACTION_1"
            //                                                                        , createParameta("action", "SL_DRUM_EQUIPMENT_GET_ACTION_1")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, ["Transferring"])
            //                                                                        , createPostReport(reports, null)));
            //Pick 위치 이동
            ...
            ////Pick 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Pick
            //                                                                        , "SL_DRUM_EQUIPMENT_GET_ACTION_2"
            //                                                                        , createParameta("action", "SL_DRUM_EQUIPMENT_GET_ACTION_2")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, null)
            //                                                                        , createPostReport(reports, null)));
            ////Pick 위치 이동
            ...
            ////Pick 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Pick
            //                                                                        , "SL_DRUM_EQUIPMENT_GET_ACTION_3"
            //                                                                        , createParameta("action", "SL_DRUM_EQUIPMENT_GET_ACTION_3")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, ["VehicleAcquireStarted"])
            //                                                                        , createPostReport(reports, ["CarrierInstalled"])));
            //Pick 위치 이동
            ...
            ////Pick 실행
            //jobTemplate.missionTemplates.Add(MissionTempleateCreateSTI(i, MissionTemplateType.Action, MissionTemplateSubType.Pick
            //                                                                        , "SL_DRUM_EQUIPMENT_GET_ACTION_4"
            //                                                                        , createParameta("action", "SL_DRUM_EQUIPMENT_GET_ACTION_4")
            //                                                                        , createParameta(null, null)
            //                                                                        , createPreReport(reports, null)
            //                                                                         , createPostReport(reports, ["VehicleAcquireCompleted"])));
            //Drop 위치 이동
        ...
        private MissionTemplate MissionTempleateCreateSTI(int JobTemplateId, MissionTemplateType type, MissionTemplateSubType SubType, string name, bool islock, Parameta parameta1, Parameta parameta2, List<PreReport> preReports, List<PostReport> postReports)
        {
            MissionTemplate missionTemplate = new MissionTemplate();
